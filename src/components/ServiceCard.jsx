...
const Servicecard = (props) => {
  return (
    <div className= '  shadow-md border border-gray-900  rounded-xl hover:bg-blue-500 grid grid-row hover:scale-110 duration-300 items-center  p-5 w-130 items-center align-center  '  >
